...
class UserModel {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.stateBridge.emit(9 /* Types.Event.Type.usersDb */, 2 /* Types.System.States.ready */);
            }
            catch (err) {
    ...
    persistUser(user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user_id } = user;
                this.stateBridge.emit(9 /* Types.Event.Type.usersDb */, user_id);
                ...
                this.stateBridge.emit(9 /* Types.Event.Type.usersDb */, 4 /* Types.System.States.reload */); // downgrade state to reload database
                return result;
            }
            catch (err) {
