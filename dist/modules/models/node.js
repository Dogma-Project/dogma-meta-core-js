    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.stateBridge.emit(8 /* Types.Event.Type.nodesDb */, 2 /* Types.System.States.ready */);
            }
            catch (err) {
    ...
    persistNodes(nodes) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.stateBridge.emit(8 /* Types.Event.Type.nodesDb */, 4 /* Types.System.States.reload */); // downgrade state to reload database
                resolve(true);
            }
            catch (err) {
                reject(err);
