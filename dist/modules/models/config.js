...
class ConfigModel {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.stateBridge.emit(Types.Event.Type.configDb, Types.System.States.ready);
            }
            catch (err) {
    ...
    persistConfig(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.stateBridge.emit(Types.Event.Type.configDb, Types.System.States.reload); // downgrade state to reload database
        });
    }
}
